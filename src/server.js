...
function getSubnetDataMetricDefs() {
  return [
    ...
    { key: 'alpha_holders_num', label: 'Alpha Holders', description: 'This is the number of unique wallets holding alpha on the subnet right now.', valueField: 'alpha_holders_num', valueFormat: 'integer', historyField: 'alpha_holders_num', chartLabel: 'Alpha Holders', chartColor: '#38bdf8', clickable: false },
